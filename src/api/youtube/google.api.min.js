...
(function() {
    ...
    var da = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        la = function(a, b, c, d) {
            ...
            b = k;
            c = b.match(ia);
            (d = b.match(ja)) && 1 === d.length && ka.test(b) && c && 1 === c.length || N("failed sanity: " + a);
            return k
        },
        na = function(a, b, c, d) {
            a = ma(a);
    ...
    var R = decodeURI("%73cript"),
        ...
        U = function() {
            var a = A.nonce;
            return void 0 !== a ? a && a === String(a) && a.match(S) ? a : A.nonce = null : h.querySelector ? (a = h.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(S) ? A.nonce = a : A.nonce = null) : null : null
        },
        pa = function(a) {
        ...
        V = function(a) {
            ...
            b.async = "true";
            (a = h.getElementsByTagName(R)[0]) ? a.parentNode.insertBefore(b, a): (h.head || h.body || h.documentElement).appendChild(b)
        },
        qa = function(a, b) {
            var c = b && b._c;
            if (c)
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.es.5tyh-J6xvvU.O/am\u003dwQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCMxgXtSPhAwC7U6c0i9yvDAOspFiA/m\u003d__features__",
            "u": "https://apis.google.com/js/api.js",
            "hee": true,
            "fp": "7343172eb5cd3211de6bc3a7118fa0556e3fbb01",
            "dpo": false
        },
        "fp": "7343172eb5cd3211de6bc3a7118fa0556e3fbb01",
...
export default gapi; /* https://apis.google.com/js/api.js */
